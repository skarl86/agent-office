...
const STORAGE_KEY = "agent-office.device-identity.v1";
      ...
      if (
        ...
        if (derivedDeviceId !== parsed.deviceId) {
          localStorage.setItem(
            STORAGE_KEY,
            JSON.stringify({ ...parsed, deviceId: derivedDeviceId } satisfies StoredIdentity),
          );
          return { deviceId: derivedDeviceId, publicKey: parsed.publicKey, privateKey: parsed.privateKey };
        }
